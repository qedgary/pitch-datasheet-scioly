...
\makeatletter % copied from TeX StackExchange
...
\def\totalScore{50} % you should fill this out manually, by adding the value of the 
...
\item The average frequency reading of a pitch on \scalebox{1.1}{\texttt{pascioly.org/sounds}} is $99.9\pm9.9$ cents lower than that on Praat. Additionally, {\texttt{pascioly.org/sounds}} does intermediate rounding, which Praat does not. If rescored, you would have earned an estimated \textbf{\pasciolyEstimate} out of 41 on the pitch score and bonus.
\end{itemize}
